...
void updateEmployee(){
	...
	while(!attr_exists){
		...
		cin >> attr;
		if(attr == "name" || attr == "id" || attr == "rank")
			attr_exists = true;
	}
	...
	file.open("Employees", std::ios_base::app);
	if(file.is_open()){
		file << "UPDATE Employees SET " << attr << " = " << changed << " WHERE name == " << name << ";\n";
		file.close();
	}
	else{
		printf("Cannot open file \"Employees\"\n");
...
void updateCustomer(){
	...
	string name;
	printf("What is the name of the customer you wish to modify?\n");
	cin >> name;
	string attr;
	bool attr_exists = false;
	while(!attr_exists){
		...
		cin >> attr;
		if(attr == "Name" || attr == "ID" || attr == "Level")
			attr_exists = true;
	}
	printf("What is the current value of the attribute you wish to update?\n");
	string old;
	...
	file.open("Customers", std::ios_base::app);
	if(file.is_open()){
		file << "UPDATE Customers SET " << attr << " = " << changed << " WHERE Name == " << name << ";";
		file.close();
	}
	else{
		printf("Cannot open file \"Customers\"\n");
...
void updateProduct(){
	string name;
	printf("What is the name of the product you wish to modify?\n");
	cin >> name;
	string attr;
	bool attr_exists = false;
	while(!attr_exists){
		...
		cin >> attr;
		if(attr == "Name" || attr == "UPC" || attr == "Price" || attr == "Quantity")
			attr_exists = true;
	}
	printf("What is the current value of the attribute you wish to update?:\n");
	string old;
	...
	file.open("Products", std::ios_base::app);
	if(file.is_open()){
		file << "UPDATE Products SET " << attr << " = " << changed << " WHERE Name == " << name << ";";
		file.close();
	}
	else{
		printf("Cannot open file \"Products\"\n");
...
void updateTransaction(){
	string id;
	printf("What is the ID of the transaction you wish to modify?\n");
	cin >> id;
	string attr;
	bool attr_exists = false;
	while(!attr_exists){
		...
		cin >> attr;
		if(attr == "ID" || attr == "Revenue" || attr == "Date" || attr == "Time")
			attr_exists = true;
	}
	printf("What is the current value of the attribute you wish to update?:\n");
	string old;
	...
	file.open("Transactions", std::ios_base::app);
	if(file.is_open()){
		file << "UPDATE Transactions SET " << attr << " = " << changed << " WHERE ID == " << id << ";";
		file.close();
	}
	else{
		printf("Cannot open file \"Transactions\"\n");
